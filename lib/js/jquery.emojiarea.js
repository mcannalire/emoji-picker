...
var emojiAreaPlugin = (function($, window, document) {
  ...
  */
    ...
    return this
      .each(function () {
        ...
        if ('contentEditable' in document.body
          ...
          var id = getGuid();
          this.EmojiArea = new EmojiArea_WYSIWYG(originalInput, id, $.extend({}, options));
        } else {
          var id = getGuid();
          this.EmojiArea = new EmojiArea_Plain(originalInput, id, options);
        }
        originalInput.attr(
          {
  ...
  var EmojiArea_Plain = function($textarea, id, options) {
    ...
    this.id = id;
    window.editorElementWYSIWYG = this.$textarea;
    this.setup();
  };
  ...
  EmojiArea_WYSIWYG.prototype.onChangeAppend = function(value) {
    var event = new CustomEvent('input', { bubbles: true });
    this.$textarea.val(this.val() + value)[0].dispatchEvent(event);
  };
...
module.exports = emojiAreaPlugin;
